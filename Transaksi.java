    ...
    public void prosesTransaksi(Client client, Transaksi transaksi, JenisLaundry jenisLaundry) {
        ...
        try {
            ...
            do {
                ...
                if (temp != 99) {
                    if (temp < 0 || temp >= jenisLaundry.getJmlJenisLaundry()) {
                        throw new InputMismatchException("Kode jenis laundry tidak valid!");
                    }
            ...
            System.out.println("Input yang dimasukkan tidak valid. Silakan masukkan angka.");
        } catch (Exception e) {
